...
import { 
  ...
  TrendingUp, Activity, Clock, FileText, ChevronRight
} from 'lucide-react';
import { toast } from 'sonner';
// Assuming bindings are generated here. If not, this line needs Wails generation.
// For now, I will use a placeholder or assume the user will run wails dev.
// I'll name the import path as per convention.
...
const Dashboard = () => {
  ...
  const loadData = async () => {
    try {
      // If the binding doesn't exist yet, this might throw. 
      // In a real dev scenario, the user reloads.
  ...
  return (
    <div className="p-6 min-h-full w-full bg-slate-50/50 font-sans animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Left Column: Agenda & Feed (2 cols wide) */}
        ...
        {/* Right Column: Charts (1 col wide) */}
        <div className="space-y-8">
          
          {/* 3A. Cursos Conflictivos */}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
            ...
            <div className="flex items-end gap-2 h-32 px-4 pb-2 border-b border-slate-200">
                {data.estudiantes_genero?.map((g, i) => {
                  ...
                  // Assuming only M/F usually, but dynamic is better
